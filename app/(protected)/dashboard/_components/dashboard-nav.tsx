...
export function DashboardNav() {
  ...
  return (
    <CookieProvider>
      <NavigationMenu
        viewport={isMobile}
        className="flex justify-between items-center w-full max-w-8xl sticky top-0 z-999 h-fit"
      >
        <NavigationMenuList className="flex-wrap flex-1">
          ...
          <NavigationMenuItem className="hidden md:block">
            ...
            <NavigationMenuContent className="flex gap-1 flex-1 min-w-8xl absolute top-0 left-0">
