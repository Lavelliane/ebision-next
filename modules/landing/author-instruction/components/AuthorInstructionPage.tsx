...
const AuthorInstructionPage = async () => {
        ...
        <div className="max-w-8xl mx-auto flex flex-col gap-10">
          ...
          <div className={`${glassCard} p-6 sm:p-8`}>
            ...
            <ol className="relative ml-4">
              {[
                { title: "Paper Submission Deadline", date: "April 12, 2026 (KST/JST)" },
                { title: "Acceptance Notification", date: "May 18, 2026 (KST/JST)" },
                { title: "Final Version Deadline", date: "May 31, 2026 (KST/JST)" },
              ].map((item, index, arr) => {
